...
A flat Markdown/LaTeX knowledge graph specification with formal cursor semantics ([TTDB-RFC-0002](RFCs/TTDB-RFC-0002-Cursor-Semantics.md)), typed directional edges ([TTDB-RFC-0003](RFCs/TTDB-RFC-0003-Typed-Edges.md)), event ID assignment with collision handling ([TTDB-RFC-0004](RFCs/TTDB-RFC-0004-Event-ID-and-Collision.md)), and toot-bit epistemic weight tracking (TBEW, [TTDB-RFC-0005](RFCs/TTDB-RFC-0005-Epistemic-Weight.md)). No database engine required; parseable on a \$5 microcontroller with \textasciitilde{}3 KB RAM overhead.
...
Future work includes formal evaluation of agent reasoning quality on benchmark knowledge graphs, multi-device TTN mesh deployments with trust gradient experiments, and clinical informatics applications using UMLS CUI grounding in the medical knowledge graph. The @PERCEPT formalism and outcome node schema (Actions 3--4 in [locus\_immediate\_next\_actions.md](locus\_immediate\_next\_actions.md)) require resolution before Paper D (AMIA) submission. A JOSS software paper is planned following Zenodo deposit.
...
\begin{itemize}
\item \textbf{RFC suite (20 RFCs):} [RFCs/INDEX.md](RFCs/INDEX.md) --- full index with status, dependencies, and cross-references. GitHub: \url{https://github.com/antfriend/antfriend.github.io/tree/master/RFCs}
\item \textbf{TTCP web viewer and TTDB collections:} \url{https://antfriend.github.io/} --- live viewer, interactive 3D globe, all example databases
\item \textbf{Affective knowledge graph (21 nodes):} \url{https://antfriend.github.io/?ttdb=feelings_ttdb.md} --- explore the valence/arousal coordinate space; begin at the [umwelt origin](\url{https://antfriend.github.io/?ttdb=feelings_ttdb.md&toot=lat0lon0}) or the [Joy node](\url{https://antfriend.github.io/?ttdb=feelings_ttdb.md&toot=lat30lon30})
\item \textbf{A32 mega TTDB (reference knowledge base):} \url{https://antfriend.github.io/?ttdb=a32_mega_ttdb.md}
\item \textbf{GitHub repository:} \url{https://github.com/antfriend/antfriend.github.io} --- source for all TTDB files, TTCP viewer, Python utilities, and build tooling
\item \textbf{Zenodo dataset deposit (DOI):} [to be added after deposit --- see Action 2 in [locus\_immediate\_next\_actions.md](locus\_immediate\_next\_actions.md)]

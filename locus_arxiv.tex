...
``\texttt{ }@PERCEPT:before\texttt{ / }@PERCEPT:after\texttt{ }``
...
``\texttt{ @LAT10LON-10 | created:1775260800 | updated:1775260800 | relates:feels>@LAT0LON0,resonates\_with>@LAT10LON20 }``
...
``\texttt{ [SOF=0xA5][VER=0x01][FLAGS][SRC\_ID:2][DST\_ID:2][TYPE][SEQ][LEN][PAYLOAD:0–240][CRC16:2][EOF=0x5A] }``

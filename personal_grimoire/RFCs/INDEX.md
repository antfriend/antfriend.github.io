...
| [TTG-RFC-0005](TTG-RFC-0005-Shapes-and-Amendments.md) | Shapes — Alternating Segments, Lists, Mentions and Amendments | A clause as any alternating run of nounish and verbish segments, each verb relating its neighbours; lists as one segment; relative clauses that close; one-word mentions; held sayings — what *or* joins, a stance verb or noun takes, a relative word reports, or a sentence the grammar reads two ways says, never believed, keeping their polarity; the two readings of one sentence named, so a question sees one saying and the owner can choose; bare verbs that go on with a relative's chain, and chain verbs learned from the owner's words; the shape notation the owner overrules a reading with; amendments kept beside the episode, and re-readings that report a grammar change without writing until the owner takes one, in order, each in the context the sentences before it stand as. |

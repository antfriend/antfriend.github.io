...
/----------------------------------------------
*/
function technical_assessment() {
  return {
    hypothesis: "Coding in an interview is something a significant number of talented software developers will fail at because the test produces extra false negative and rare true positive results.  There is a better way.",
    ...
    alternative: "Perform the technical assessment portion of the interview by discussing recent original sample code the developer brings to the interview as a portfolio of representative work.",
    copyright: "@copyright 2017 Dan Ray",
    license: "MIT"
  };
}

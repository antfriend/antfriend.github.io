    ...
    const DB_CANDIDATE_PATHS = [DEFAULT_DB_PATH, "TootTootTerminologyDB.md", "journals.md", "MyMentalPalaceDB.md", "BOI_approach_plates.md", "Mathematical.latex", "banjo_ttdb.md"];

    ...
    const DB_CANDIDATE_PATHS = [DEFAULT_DB_PATH,"agent-memory-system_ttdb.md","companion_arcprize.md", "TootTootTerminologyDB.md", "story_of_stories_ttdb.md", "bioelectric_resonance.md", "feelings_ttdb.md", "journals.md", "BOI_approach_plates.md", "Mathematical.latex", "banjo_ttdb.md", "pollan_world_appears_ttdb.md"];

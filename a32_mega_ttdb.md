...
preview:
  ...
  @LAT10LON-10: "Narrative Compression. Five TTDBs, same pattern. Bioelectric case adds: the prior can degrade — conf degradation is semantic aging. High EPS = the shared prior is no longer expanding correctly."
